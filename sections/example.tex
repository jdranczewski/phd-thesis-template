...
\label{ch:example}
% The first page of a chapter should not have a header at the top, specify the style for this page.
\thispagestyle{plainheadline}
...
Here's an example figure: Fig.~\ref{fig:a_example_a_wide}
...
\begin{figure}[h]
	...
	\label{fig:a_example_a_wide}
\end{figure}

Here's an example of a narrow figure with the caption to the side: Fig.~\ref{fig:a_example_b_narrow}
